...
Reasoner that generates questions and checks compatibility.
"""
...
3. Evaluate proposal compatibility objectively
...
Be structured, objective, and thorough. Prioritize clarity over creativity."""
    ...
    def _track_tokens(self, result) -> None:
        ...
        if self.system_prompt:
            cumulative_size += len(self.system_prompt) // 4

        for msg in self._context_messages:
            content = str(msg.get('content', ''))
            cumulative_size += len(content) // 4
        ...
        self._last_token_usage = {
            ...
            "context_estimated": cumulative_size,
